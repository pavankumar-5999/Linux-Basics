...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| Add a new user                 | `adduser username` *(interactive, prompts for password and details)* OR `useradd username + passwd username` OR `useradd -m username + passwd username` | `userdel username` *(add -r to remove home directory)*   |
